            ...
            const { error: dbError } = await supabase.from('leads').insert([
                {
                    ...
                    message: `AGENCIA: ${formState.agencyName} (Tax ID: ${formState.taxId}). Properties: ${formState.propertiesCount}. Types: ${formState.propertyTypes.join(', ')}. Msg: ${formState.message}`,
                    role: 'agency',
                    status: 'new'
                }
            ]);
