            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3 pt-2">
                        <label className="block text-sm font-medium text-gold-500">Legal Entity Type</label>
                        <div className="flex gap-6">
                            <label className="flex items-center cursor-pointer">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="form-radio text-gold-500 focus:ring-gold-500 bg-midnight-950 border-white/10"
                                />
                                <span className="ml-2 text-gray-300 text-sm">Individual Investor</span>
                            </label>
                            <label className="flex items-center cursor-pointer">
                                <input
                                    type="radio"
                                    ...
                                    className="form-radio text-gold-500 focus:ring-gold-500 bg-midnight-950 border-white/10"
                                />
                                <span className="ml-2 text-gray-300 text-sm">Company / Legal Entity</span>
                            </label>
                        </div>
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        placeholder="e.g. Investment Holdings LLC"
                                        className="w-full bg-midnight-950 border border-white/10 rounded-lg p-2.5 text-white focus:ring-1 focus:ring-gold-500"
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-400 mb-1">Legal Representative Name</label>
                                    <input
                                        required={formData.entityType === 'company'}
