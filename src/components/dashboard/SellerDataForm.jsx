            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* New Fields: Description & Dossier */}
                        <div className="grid grid-cols-1 gap-4 mt-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-400 mb-1">Property Description</label>
                                <textarea
                                    name="description"
                                    value={propertyData.description}
                                    onChange={handlePropertyChange}
                                    rows={4}
                                    placeholder="Key features, current condition, surface areas, etc."
                                    className="w-full bg-midnight-950 border border-white/10 rounded-lg p-2.5 text-white focus:ring-1 focus:ring-gold-500"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-400 mb-1">Dossier / Photos URL (Google Drive/Dropbox)</label>
                                <input
                                    name="dossier_url"
                                    value={propertyData.dossier_url}
                                    onChange={handlePropertyChange}
                                    placeholder="https://..."
                                    className="w-full bg-midnight-950 border border-white/10 rounded-lg p-2.5 text-white focus:ring-1 focus:ring-gold-500"
                                />
                                <p className="text-xs text-gray-500 mt-1">Please provide a link to the property photos or dossier for evaluation.</p>
                            </div>
                        </div>
                    </div>
                </div>
